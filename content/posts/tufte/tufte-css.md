...
[In his later books]{.newthought}[^1], Tufte starts each
...
>
> [Richard P. Feynman, <cite>"What Do You Care What Other People Think?"</cite>]{.footer}
> 
...
![Exports and Imports to and from Denmark & Norway from 1700 to 1780]({static}/posts/tufte/img/exports-imports.png)
</figure>
...
[^rhino]: {-}
  ![Image of a Rhinoceros]({static}/posts/tufte/img/rhino.png) F.J. Cole, "The History of Albrecht
...
campaign, 1812-1813]({static}/posts/tufte/img/napoleons-march.png)
</figure>
...
<figure class="fullwidth">
![Image of Chinese Calligraphy]({static}/posts/tufte/img/imagequilt-chinese-calligraphy.png)
</figure>
...
<figure>
![Image of animal sounds]({static}/posts/tufte/img/imagequilt-animal-sounds.png)
</figure>
